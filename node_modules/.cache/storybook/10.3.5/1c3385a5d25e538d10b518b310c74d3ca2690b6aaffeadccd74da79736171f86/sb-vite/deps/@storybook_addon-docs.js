...
import { C as definePreviewAddon10 } from "./components-COgJbDWK.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-D_iWej9F.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-CDcz9a7X.js");
